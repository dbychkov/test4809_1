...
uint8_t parse_fat32_info(uint8_t *sector, fat32_info_t *info) {
    info->bytes_per_sector = sector[11] | (sector[12] << 8);
    info->sectors_per_cluster = sector[13];
    info->reserved_sector_count = sector[14] | (sector[15] << 8);
    info->num_fats = sector[16];
    info->fat_size = sector[36] | (sector[37] << 8) | (sector[38] << 16) | (sector[39] << 24);
    info->root_cluster = sector[44] | (sector[45] << 8) | (sector[46] << 16) | (sector[47] << 24);
...
int main(void) {
    ...
    uint32_t part_start = sector[454] | (sector[455]<<8) | (sector[456]<<16) | (sector[457]<<24);
